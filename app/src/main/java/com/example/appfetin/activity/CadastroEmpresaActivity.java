                    ...
                    if(!textoSenha.isEmpty()){
                        if(!textoTelefone.isEmpty()){
                            if(!textoEndereco.isEmpty()){
                                    ...
                                    if(!textoCategoria.isEmpty()){
                                        if(!textoTempo.isEmpty()){
                                            if(!textoPreco.isEmpty()){
                                                ...
                                                empresa.setTelefoneP("Não informado");
                                                ...
                                                Toast.makeText(CadastroEmpresaActivity.this, "Informe o preço padrão de entrega!", Toast.LENGTH_SHORT).show();
                                            }
                                        }else{
                                            Toast.makeText(CadastroEmpresaActivity.this, "Informe o tempo de entrega padrão!", Toast.LENGTH_SHORT).show();
                                        }
                                    }else{
                                ...
                                Toast.makeText(CadastroEmpresaActivity.this, "Informe um endereço!", Toast.LENGTH_SHORT).show();
                            }
                        }else{
